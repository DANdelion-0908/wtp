        ...
        <div className="card w-[40%] pb-[5%] h-full overflow-auto shadow-xl">
            ...
            {user1 ? (
                <div className='bg-primary flex gap-5 p-3 items-center rounded-xl'>
                    <div className='bg-black rounded-full w-[20%] h-[70%] flex items-center justify-center'>
                    ...
                    <div className='flex flex-col h-auto gap-[10%] w-full'>
                        <div className='flex flex-col gap-[1%]'>
                            <div className='flex'>
                                <h2 className="card-title font-bold self-start text-4xl text-white">{user1.first_name} {user1.last_name}</h2>
                                <img
                            ...
                            <p className='text-2xl'>{user1.user_name}</p>
                        </div>
                        ...
                        <div className='card bg-base-200 mb-[2%] w-[100%] shadow-xl' key={index}>
                            ...
                            <div>
                                <div className="card-body items-center">
                                    ...
                                    <div className="card-actions w-full self-end justify-between">
                                        <div className='mr-5'>
                                            <button disabled="disabled" className='pr-5'>
                                                <svg
